...
Defense: {self.defense}\n""")
    ...
    def P_attack(self, Edefense):
        ...
        if nA == 1:
            ...
            if crit_dmg <= 0:
                return 0
            print(f"You had a critical hit and dealt {crit_dmg} damage!\n")
            return crit_dmg
    ...
    def levelUp(self):
        ...
        while decision.lower() != "hp" and decision.lower() != "atk" and decision.lower() != "def" and decision.lower() != "spd":
            decision = input("What stat would you like to improve?: (Hp, Atk, Def, Spd)\n")
        if decision.lower() == "hp":
            self.originhp += 2
            print("Your HP has increased!\n")
        elif decision.lower() == "atk":
            self.attack += 1
            print("Your Attack has increased!\n")
        elif decision.lower() == "def":
            self.defense += 1
            print("Your Defense has increased!\n")
        elif decision.lower() == "spd":
            self.speed += 1
